...
sGradient stuff_bar_gradient[ 11 ] = {
	{{ 0, 120, 0, 0 },      0.0 },
        { { 10, 210, 50, 0 },   0.1 },
        { { 100, 150, 150, 0 }, 0.28},
	{ { 100, 170, 170, 0 }, 0.31},
...
// Explosion sGradient
sGradient explosion_gradient1[ 3 ] = {
	{{ 150, 75, 30, 0 },    0.0},
	{ { 255, 255, 255, 0 }, 1.0},
	{ { 0, 0, 0, 0 },       -1 }
};
...
// Explosion sGradient
sGradient explosion_gradient2[ 3 ] = {
	{{ 255, 255, 102, 0 }, 0.0}, // ff6
	{ { 255, 136, 0, 0 },  1.0}, // f80
	{ { 0, 0, 0, 0 },      -1 }
};

sGradient* explosion_gradients[ 2 ] = { explosion_gradient1, explosion_gradient2 };
